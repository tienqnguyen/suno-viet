...
// @version      1.1.0
// @description  Standalone lyric generator using EXISTING Suno style input. Panel on left-center. Display songs & inject per song. Bản này AI tạo nhạc theo style có sẵn ở input form >>> chỉ cẩn cho vài keywords là AI sẽ tạo bài nhạc dựa theo STYLE có sẵn
...
(function () {
    ...
    class SunoStyleLyricGenerator {
        ...
        injectUI() {
            ...
            panel.id = 'sslg-panel';
            panel.innerHTML = `
                <div style="font-weight:700;font-size:14px;margin-bottom:8px">🎵 Lyric Generator</div>
                ...
                <button id="sslg-generate-style"
                    style="width:100%;background:#7c3aed;color:#fff;font-weight:600;margin-bottom:6px">
        ...
        renderSongList() {
            ...
            this.songs.forEach((song, idx) => {
                ...
                div.innerHTML = `
                    ...
                    <button data-i="${idx}" style="width:100%;font-size:12px">🚀 Inject title + lyric</button>
                `;
